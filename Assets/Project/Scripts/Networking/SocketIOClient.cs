...
namespace Salem.Networking
{
    ...
    /// NOT a MonoBehaviour ΓÇö owned and driven by NetworkManager.
    ///
    ...
    {
        // ΓöÇΓöÇΓöÇ State ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        // ΓöÇΓöÇΓöÇ Public API ΓÇö Events ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

        public event Action OnConnected;
        public event Action<string> OnDisconnected;

        // ΓöÇΓöÇΓöÇ Public API ΓÇö Lifecycle ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        // ΓöÇΓöÇΓöÇ Public API ΓÇö Event Registration ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        // ΓöÇΓöÇΓöÇ Public API ΓÇö Sending ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        public async Task Emit(string eventName)
        {
            if (!IsConnected)
            {
                Debug.LogWarning($"[SocketIO] Cannot emit '{eventName}' ΓÇö not connected.");
                return;
            }
        ...
        // ΓöÇΓöÇΓöÇ Wire Protocol Handling ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        private void HandleMessage(string message)
        {
            ...
            switch (packetType)
            {
                case '0': // Engine.io OPEN ΓÇö handshake
                ...
                case '3': // Engine.io PONG (server responding to our ping ΓÇö unlikely but handle)
                    lastPingTime = Time.realtimeSinceStartup;
                    break;
        ...
        private void HandleSocketIOPacket(char socketType, string data)
        {
            switch (socketType)
            {
                case '0': // CONNECT ΓÇö namespace connected
                ...
                case '2': // EVENT ΓÇö 42["eventName",{payload}]
                    if (data != null)
                    {
        ...
        ///
        /// Manual string parsing ΓÇö no JSON parser for the outer array because
        ...
        private void ParseAndRouteEvent(string data)
        {
            ...
            if (commaIndex >= 0)
            {
                // Payload exists ΓÇö extract from after comma to before closing ]
        ...
        // ΓöÇΓöÇΓöÇ Raw Send ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

        private async Task SendRaw(string message)
        {
            if (ws == null || ws.State != WebSocketState.Open)
            {
                Debug.LogWarning($"[SocketIO] Cannot send ΓÇö WebSocket not open. Message: {message}");
                return;
            }
