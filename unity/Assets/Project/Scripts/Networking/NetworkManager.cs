...
namespace Salem.Networking
{
    ...
    ///
    /// This is a relay bridge — it does NOT drive GamePhaseManager or GameTurnManager.
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        // ─── Inbound Events (game systems subscribe to these) ────
        ...
        private void Update()
        {
            ...
            // Check for ping timeout → trigger reconnect
            if (socketClient.IsConnected &&
                socketClient.TimeSinceLastPing > socketClient.PingTimeoutThreshold)
            {
                Debug.LogWarning("[NetworkManager] Ping timeout — connection may be stale. Reconnecting...");
        ...
        private void RegisterHandlers()
        {
            ...
            socketClient.On("player_action", json =>
            {
                ...
                Debug.Log($"[NetworkManager] Player action from {msg.playerId}: {msg.card} → {msg.targetPlayerId}");
